        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    <img src="{{ asset(config('app.demo_branding') ? 'images/clientnobg.png' : (config('app.product') === 'novustream' ? 'images/novustreamlogo.png' : 'images/novusurgelogo.png')) }}" alt="" class="w-75">
